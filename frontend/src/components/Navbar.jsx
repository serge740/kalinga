        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="bg-gradient-to-r from-red-600 to-red-700 text-white px-6 py-2 rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 font-medium" onClick={()=> handleNavigate('/contant')}>
                Get In Touch
              </button>
            </div>
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="px-4 py-6 space-y-3">
            ...
            <div className="pt-4 border-t border-gray-100 space-y-3">
              ...
              <button className="w-full bg-gradient-to-r from-red-600 to-red-700 text-white py-3 rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 shadow-lg font-medium" onClick={()=> handleNavigate('/contant')}>
                           Get In Touch
              </button>
            </div>
          </div>
